...
export default function SocialLinks() {
    return (
        <div className="inline-flex items-center justify-center space-x-8 rounded-full border border-transparent bg-white text-blue-950 py-2 text-sm font-bold hover:border-gray-800">
            <Link
